...
<div class="container-fluid">
    ...
    <div class="modal fade" id="addFloorModal" tabindex="-1" role="dialog" aria-labelledby="addFloorModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <label class="dropzone mb-3" for="image" id="dropzone">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
                    <!-- Add any buttons for submitting or saving floors here -->
                </div>
            </div>
        </div>
    </div>
    ...
    <script>
        ...
        function addMarker(location) {
            ...
            infowindowContent += '<button class="btn btn-info btn-sm" title="View"><i class="ti ti-eye"></i></button> ';
            infowindowContent += '<button class="btn btn-success btn-sm" title="Add Floors" data-toggle="modal" data-target="#addFloorModal"><i class="ti ti-stairs"></i></button>';
